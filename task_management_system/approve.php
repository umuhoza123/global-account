				...
				<div class="row">
					<div class="col-md-6 border-right">
						<div class="form-group">
							...
							<input type="text" name="firstname" class="form-control form-control-sm" required value="<?php echo isset($name) ? $name : '' ?>">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" name="lastname" class="form-control form-control-sm" required value="<?php echo isset($phone) ? $phone : '' ?>">
						</div>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<input type="password" class="form-control form-control-sm" name="password" <?php echo isset($password) ? $password : '' ?>>
							<small><i><?php echo isset($id) ? "Leave this blank if you dont want to change you password":'' ?></i></small>
						</div>
						<div class="form-group">
							<label class="label control-label">Confirm Password</label>
							<input type="password" class="form-control form-control-sm" name="" <?php echo isset($password) ? $password : '' ?>>
		...
		$.ajax({
			...
			success:function(resp){
				...
				if(resp == 1){
					...
					alert_toast('Data failed to be  saved.',"fail");
					setTimeout(function(){
						location.replace('index.php?page=user_list')
					},750)
