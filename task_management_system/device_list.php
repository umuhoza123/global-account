	...
	<div class="card card-outline card-success">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_device"><i class="fa fa-plus"></i> Add New device</a>
			</div>
		</div>
		<div class="card-body">
			<table class="table tabe-hover table-condensed" id="list">
				...
				<tbody>
					...
					$qry = $conn->query("SELECT * FROM system_device WHERE editor = '$editor'");
					...
					<tr>
						...
						<td>
							<p><b><?php echo ucwords($row['device']) ?></b></p>
